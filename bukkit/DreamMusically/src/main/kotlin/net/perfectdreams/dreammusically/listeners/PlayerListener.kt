    ...
    fun onInteract(e: PlayerInteractEvent) {
        ...
        if (itemInPlayerMainHand.type == Material.CARROT_ON_A_STICK) {
            ...
            if (customPlayingSong != null) {
                ...
                val nmsWorld = (e.player.world as org.bukkit.craftbukkit.v1_19_R3.CraftWorld).handle
                ...
                m.schedule {
                    ...
                    nmsJukebox.setRecordWithoutPlaying(org.bukkit.craftbukkit.v1_19_R3.inventory.CraftItemStack.asNMSCopy(copyOfItemInMainHand))
