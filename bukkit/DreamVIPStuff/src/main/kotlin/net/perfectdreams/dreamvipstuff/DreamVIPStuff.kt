...
class DreamVIPStuff : KotlinPlugin(), Listener {
	companion object {
		...
		private val vipNpcIds = listOf(
			1057, 1056, 1055, 1054, 1053, 1052, 1051, 1050, 1049, 1048, 1047, 1046, 1045, 1044, 1043, 1042, 1041, 1040, 1039, 1038, 447, 724, 725, 489, 456, 455, 741, 742, 743, 774, 775, 776, 778, 779, 780, 781, 783
		)

		private val vipPlusNpcIds = listOf(
			1077, 1076, 1075, 1074, 1073, 1072, 1071, 1070, 1069, 1068, 1067, 1066, 1065, 1064, 1063, 1062, 1061, 1060, 1059, 1058, 744, 745, 746, 747, 748, 749, 750, 751, 752, 753, 754, 756, 758, 759, 760, 761, 762
		)

		private val vipPlusPlusNpcIds = listOf(
			1037,1036,1035,1034,1033,1032,1031,1030,1029,729, 732, 731, 735, 740, 736, 738, 739, 733, 726, 737, 763, 764, 765, 766, 767, 769, 770, 771, 772, 773, 768
		)
	}
