    ...
    fun onInteract(e: PlayerInteractEvent) {
        ...
        if (itemInPlayerMainHand.type == Material.CARROT_ON_A_STICK) {
            ...
            if (customPlayingSong != null) {
                ...
                val nmsWorld = (e.player.world as org.bukkit.craftbukkit.v1_16_R2.CraftWorld).getHandle() as net.minecraft.server.v1_16_R2.World
                val tileEntity = nmsWorld.getTileEntity(net.minecraft.server.v1_16_R2.BlockPosition(clickedBlock.x, clickedBlock.y, clickedBlock.z))

                val copyOfItemInMainHand = e.player.inventory.itemInMainHand.clone()

                m.schedule {
                    waitFor(1)
                    val nmsJukebox = tileEntity as net.minecraft.server.v1_16_R2.TileEntityJukeBox
                    nmsWorld.setTypeAndData(
                        nmsJukebox.getPosition(),
                        net.minecraft.server.v1_16_R2.Blocks.JUKEBOX.getBlockData().set(
                            net.minecraft.server.v1_16_R2.BlockJukeBox.HAS_RECORD,
                            true
                        ) as net.minecraft.server.v1_16_R2.IBlockData,
                        3
                    )

                    nmsJukebox.setRecord(org.bukkit.craftbukkit.v1_16_R2.inventory.CraftItemStack.asNMSCopy(copyOfItemInMainHand))
